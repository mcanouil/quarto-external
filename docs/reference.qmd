...
A path is resolved from the working directory of the render, so a file outside the project is reached the same way any relative path would be.
...
| --- | --- |
| none | The whole file. |
| `#<id>` | The section whose heading carries that identifier, heading included. If no heading matches, the div carrying it. |
| `#L<n>` | A single line. |
